var preguntas=[
    ...
    "¿Cuándo fue la última vez que fuiste al médico y/o te realizaste un chequeo general? No consideres",
...
function mostrarResultado(){
    ...
    img.setAttribute("src","https://concepto.de/wp-content/uploads/2013/08/salud-OMS-e1551914081412.jpg"); 
    img.setAttribute("width","450"); 
    img.setAttribute("height","260"); 
    document.getElementsByClassName("opciones")[0].appendChild(img);
